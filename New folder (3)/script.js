...
const poemLinePairs = [
    ["A sister like you is a gift so rare,", "A bond of friendship beyond compare."],
    ["Through every laugh and every tear,", "You're always someone I hold so dear."],
    ["A secret keeper and a guiding light,", "You make the heavy days feel bright."],
    ["In this garden of life, you're the finest bloom,", "Whose warmth and kindness dispels the gloom."],
    ["Happy Rose Day to my sister and my friend,", "A bond of heart that will never end."]
];
    ...
    if (currentVerse === 0) {
        ...
        tl.call(() => {
            confetti({
                ...
                spread: 100,
                origin: { y: 0.7 },
                colors: ['#ffb7c5', '#e0c3fc', '#ff8fa3', '#b19cd9', '#9bc88a']
            });
        }, null, "+=0.5");
